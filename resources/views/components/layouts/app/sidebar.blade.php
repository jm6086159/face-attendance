    ...
    <head>
        ...
        <style>
            ...
            body {
                ...
                background:
                    radial-gradient(ellipse at 20% 10%, rgba(15, 157, 88, 0.28), transparent 36%),
                    radial-gradient(ellipse at 80% 20%, rgba(232, 180, 0, 0.18), transparent 40%),
                    linear-gradient(140deg, var(--brand-navy) 0%, #0d2f32 42%, #081814 100%);
            }
        </style>
    </head>
    <body class="min-h-screen">
        <flux:sidebar sticky stashable class="border-e bg-[var(--brand-green)] text-white" style="border-right-color: rgba(232,180,0,.55)">
            ...
            <flux:navlist variant="outline">
                <flux:navlist.group :heading="__('Platform')" class="grid">
                    ...
                    <flux:navlist.item icon="clock" :href="route('attendance.index')" :current="request()->routeIs('attendance.index')" wire:navigate>{{ __('Attendance') }}</flux:navlist.item>
